...
![iOS 27 Extensions 工作原理](images/iOS27模型入口/extensions-mechanism.png)
...
![AI 竞争的三个发展阶段](images/iOS27模型入口/three-phases.png)
...
![AI 模型竞争格局](images/iOS27模型入口/competitive-landscape.png)
