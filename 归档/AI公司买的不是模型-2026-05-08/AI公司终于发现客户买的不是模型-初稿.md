...
同一天，Anthropic 发布了面向金融行业的专用 AI Agent。CEO Dario Amodei 和摩根大通 CEO Jamie Dimon 同台站台。

挑几个代表任务：自动生成 pitchbook、构建财务模型、审计和估值审核、KYC 和合规调查。这些 Agent 接入了 Dun & Bradstreet 和 Moody's 等数据源，能直接在 Excel 和 PowerPoint 里工作。

消息公布当天，金融数据公司 FactSet 的股价跌了约 8%。
